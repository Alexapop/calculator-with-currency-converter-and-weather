<template>
  ...
  >
    ...
    <div class="calculator__keys" aria-label="Calculator keypad">
      <button class="calculator__key calculator__key--clear" type="button">
        CE
      </button>
      <button class="calculator__key calculator__key--memory" type="button">
        MC
      </button>
      <button class="calculator__key calculator__key--memory" type="button">
        MR
      ...
      <button class="calculator__key calculator__key--digit" type="button">
        7
      </button>
      <button class="calculator__key calculator__key--digit" type="button">
        8
      ...
      <button class="calculator__key calculator__key--operator" type="button">
        ÷
      </button>
      <button class="calculator__key calculator__key--digit" type="button">
        4
      ...
      <button
        class="calculator__key calculator__key--digit calculator__key--zero"
        type="button"
      >
        0
      </button>
      ...
      <button class="calculator__key calculator__key--equals" type="button">
        =
      </button>
      <button class="calculator__key calculator__key--operator" type="button">
        +
